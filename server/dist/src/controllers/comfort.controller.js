...
const comfort_service_1 = require("../services/comfort.service");
const passport_1 = require("@nestjs/passport");
const swagger_1 = require("@nestjs/swagger");
const create_message_request_1 = require("../constants/requests/comfort/create-message.request");
const next_response_1 = require("../constants/responses/comfort/next.response");
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOkResponse)({ type: next_response_1.NextComfortResponseDto }),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, create_message_request_1.CreateMessageRequestDto]),
    __metadata("design:returntype", void 0)
